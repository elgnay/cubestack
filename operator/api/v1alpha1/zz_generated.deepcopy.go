...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AssetRef) DeepCopyInto(out *AssetRef) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AssetRef.
func (in *AssetRef) DeepCopy() *AssetRef {
	if in == nil {
		return nil
	}
	out := new(AssetRef)
...
func (in *DevEnvironmentSpec) DeepCopyInto(out *DevEnvironmentSpec) {
	*out = *in
	...
	if in.AssetRefs != nil {
		in, out := &in.AssetRefs, &out.AssetRefs
